...
sys.path.append("..")
from scrapy.case_scrapy.items import case_Items
...
class StanfordClassAction(scrapy.Spider):
    name = "stanford_class_action"

    def start_requests(self):
        df_case_links_clean = pd.read_excel(
            "/Users/yuchen.zhang/Documents/Projects/Class_Action/class_action_git/data/case_links_all.xlsx")
    ...
    def parse_pages(self, response):
        ...
        try:
            ...
            case_name = summary_section.find("div", attrs={"class": "page-header hidden-phone"}).text.strip().replace(
                'Case Summary\n', '')
